...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    */
    (*pButtonLedService->onBleEvent)(pButtonLedService, p_ble_evt);
}
...
void bsp_event_handler(bsp_event_t event)
{
    ...
    switch (event)
    {
        case BSP_EVENT_SLEEP:
            SEGGER_RTT_printf(0, "Sleeping\n");
            sleep_mode_enter();
            break;

        case BSP_EVENT_DISCONNECT:
            SEGGER_RTT_printf(0, "Disconnectting\n");
        ...
        case BSP_EVENT_WHITELIST_OFF:
            SEGGER_RTT_printf(0, "Turning whitelist off\n");
